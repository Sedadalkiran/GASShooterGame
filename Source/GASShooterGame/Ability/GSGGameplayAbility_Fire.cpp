                                               ...
                                               const FGameplayEventData* TriggerEventData)
{
	...
	check(AbilityComp);
	OnTargetDataReadyCallbackDelegateHandle = AbilityComp->AbilityTargetDataSetDelegate(
                                          ...
                                          bool bReplicateEndAbility, bool bWasCancelled)
{
	...
	AbilityComp->AbilityTargetDataSetDelegate(CurrentSpecHandle, CurrentActivationInfo.GetActivationPredictionKey()).
	             Remove(OnTargetDataReadyCallbackDelegateHandle);
	AbilityComp->ConsumeClientReplicatedTargetData(CurrentSpecHandle,
...
void UGSGGameplayAbility_Fire::StartWeaponTargeting()
{
	UAbilitySystemComponent* AbilityComp = CurrentActorInfo->AbilitySystemComponent.Get();
	check(AbilityComp);
	FScopedPredictionWindow ScopedPrediction(AbilityComp, CurrentActivationInfo.GetActivationPredictionKey());
	/*Wait server client*/
	FHitResult OutHit;
